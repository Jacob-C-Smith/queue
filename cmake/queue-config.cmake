...
set(QUEUE_LIBRARIES queue::queue)

# All targets are created, even when some might not be requested though COMPONENTS.
# This is done for compatibility with CMake generated QUEUE-target.cmake files.

set(_QUEUE_library     "${QUEUE_LIBDIR}/queue.lib")
set(_QUEUE_dll_library "${QUEUE_BINDIR}/queue.dll")
if(EXISTS "${_QUEUE_library}" AND EXISTS "${_QUEUE_dll_library}")
    if(NOT TARGET queue::queue)
        add_library(queue::queue SHARED IMPORTED)
        set_target_properties(queue::queue
            PROPERTIES
